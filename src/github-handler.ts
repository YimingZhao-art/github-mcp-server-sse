	...
	return new Response(null, {
		...
		headers: {
			...
			location: getUpstreamAuthorizeUrl({
				...
				scope: 'repo user admin:org admin:public_key admin:repo_hook gist notifications read:org read:public_key read:repo_hook write:discussion write:packages workflow read:user user:email user:follow delete_repo admin:gpg_key',
